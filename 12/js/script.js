...
/***/ "./source/js/libs/format-time.js":
/*!***************************************!*\
  !*** ./source/js/libs/format-time.js ***!
  \***************************************/
/*! exports provided: parseTime, numberToPadString, standardFormatter, formatTime */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "parseTime", function() { return parseTime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "numberToPadString", function() { return numberToPadString; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "standardFormatter", function() { return standardFormatter; });
...
function numberToPadString(num) {
  if (!isNil(num)) {
    num = num.toString();
...
function standardFormatter(timeData) {
  timeData = [
...
function formatTime(time, formatter = standardFormatter) {
...
/***/ "./source/js/libs/promise-series.js":
/*!******************************************!*\
  !*** ./source/js/libs/promise-series.js ***!
  \******************************************/
/*! exports provided: promiseSeries */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "promiseSeries", function() { return promiseSeries; });
function promiseSeries(funcs, initial) {
  return funcs.reduce(
      (p, f) => p.then(f),
...
/* harmony import */ var _libs_timer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../libs/timer */ "./source/js/libs/timer.js");
/* harmony import */ var _libs_format_time__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../libs/format-time */ "./source/js/libs/format-time.js");
...
function initGame() {
  ...
  function renderCounter(time) {
    counterElement.textContent = Object(_libs_format_time__WEBPACK_IMPORTED_MODULE_1__["formatTime"])(time / 1000, (timeData) => {
      return `${Object(_libs_format_time__WEBPACK_IMPORTED_MODULE_1__["numberToPadString"])(timeData.min)}:${Object(_libs_format_time__WEBPACK_IMPORTED_MODULE_1__["numberToPadString"])(timeData.sec)}`;
    });
  }

  const timer = new _libs_timer__WEBPACK_IMPORTED_MODULE_0__["Timer"]({
    fps: 1,
    render: () => {
      gameTime -= 1000;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return initPrizes; });
/* harmony import */ var _libs_delay__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../libs/delay */ "./source/js/libs/delay.js");
/* harmony import */ var _libs_promise_series__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../libs/promise-series */ "./source/js/libs/promise-series.js");
/* harmony import */ var _libs_load_image__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../libs/load-image */ "./source/js/libs/load-image.js");
/* harmony import */ var _libs_timer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../libs/timer */ "./source/js/libs/timer.js");
...
function animatePrizeCounter({values, element}) {
  return new Promise((resolve) => {
    const timer = new _libs_timer__WEBPACK_IMPORTED_MODULE_3__["Timer"]({
      fps: 12,
      render: () => {
...
function waitForItem(item) {
  ...
  return Object(_libs_load_image__WEBPACK_IMPORTED_MODULE_2__["loadImage"])(item.querySelector(imageSelector))
    .then(() => item.classList.add(itemInitedClass))
    .then(() => Promise.all([
      Object(_libs_delay__WEBPACK_IMPORTED_MODULE_0__["delay"])(imageDuration),
      Object(_libs_delay__WEBPACK_IMPORTED_MODULE_0__["delay"])(imageDuration - 1000)
        .then(() => {
...
function initPrizes() {
  ...
  document.body.addEventListener(`screenChanged`, function onInit(event) {
    ...
    Object(_libs_delay__WEBPACK_IMPORTED_MODULE_0__["delay"])(initialDelay)
      .then(Object(_libs_promise_series__WEBPACK_IMPORTED_MODULE_1__["promiseSeries"])(animationItemsPromises));
  });
}
...
/* harmony default export */ __webpack_exports__["default"] = (initRules);
...
/***/ "./source/js/modules/split-title.js":
/*!******************************************!*\
  !*** ./source/js/modules/split-title.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _libs_split_text__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../libs/split-text */ "./source/js/libs/split-text.js");
...
function initSplitTitle() {
  Array.from(document.querySelectorAll(titleSelector))
    .map(_libs_split_text__WEBPACK_IMPORTED_MODULE_0__["default"].of)
    .forEach((splitText) => {
      splitText
        .visitor(({type, element, data}) => {
          switch (type) {
            case _libs_split_text__WEBPACK_IMPORTED_MODULE_0__["default"].NODES.ROOT: {
              element.classList.add(`split-text`);
              break;
            }

            case _libs_split_text__WEBPACK_IMPORTED_MODULE_0__["default"].NODES.LINE: {
              element.classList.add(`split-text__line`);
              break;
            }

            case _libs_split_text__WEBPACK_IMPORTED_MODULE_0__["default"].NODES.WORD: {
              element.classList.add(`split-text__word`);
              break;
            }

            case _libs_split_text__WEBPACK_IMPORTED_MODULE_0__["default"].NODES.LETTER: {
            ...
            case _libs_split_text__WEBPACK_IMPORTED_MODULE_0__["default"].NODES.SPACE: {
...
/* harmony default export */ __webpack_exports__["default"] = (initSplitTitle);
...
/* harmony import */ var _modules_split_title__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/split-title */ "./source/js/modules/split-title.js");
/* harmony import */ var _modules_prizes__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/prizes */ "./source/js/modules/prizes.js");
/* harmony import */ var _modules_game__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/game */ "./source/js/modules/game.js");
// modules
...
Object(_modules_split_title__WEBPACK_IMPORTED_MODULE_11__["default"])();
Object(_modules_prizes__WEBPACK_IMPORTED_MODULE_12__["default"])();
Object(_modules_game__WEBPACK_IMPORTED_MODULE_13__["default"])();
